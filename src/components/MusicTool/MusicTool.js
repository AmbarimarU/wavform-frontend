                ...
                <div className="musictool-main">
                    <div className="musictool-header">
                        <div className="musictool-top">
                            ...
                            <div>
                                <button className="musictool-button">
                                    View Tutorial
                                </button>
                                <button className="musictool-button">
                                    Get Help
                        ...
                        <span>
                            Each synth and sampler boast its own soundsboard for
                            crafting melodies. Simply click on the squares to
                            add or remove notes, even while the music plays. The
                            vertical axis represents your notes, and the
                            horizontal axis sets the sequence. Hit play, make
                            adjustments on the fly, and when your done hit stop.
                        ...
                        <div className="musictool-sampler">
                            <button
                                ...
                                onClick={(e) => {
                                    ...
                                    sampler1Sequencer.style.visibility =
                                        "hidden";
                                    sampler1Octave.style.visibility = "hidden";

                                    sampler2Sequencer.style.visibility =
                                        "hidden";
                        ...
                        <div className="musictool-stepsequencer">
                            ...
                            <div className="musictool-sequencer">
                                <Sequencer
                                    ...
                                    instrumentChanges1={
                                        instrumentChanges.sampler1
                                    }
                                    instrumentChanges2={
                                        instrumentChanges.sampler2
                                    }
                    ...
                    <div className="musictool-sounds">
                        <h6 className="musictool-sounds-header">
                            ...
                            <div class="tooltip-container">
                                ...
                                <span class="toolbox">
                                    Each sound has its own unique
                                    characteristic. You can adjust the octave,
                                    synthesizer, and sampler for each sound.
                                    <br />
                                    <br />
                                    <span style={{ fontWeight: "bold" }}>
                                        Octave:
                                    </span>{" "}
                                    The octave of the sound. A higher octave
                                    will sound higher pitched.
                                    <br />
                                    <br />
                                    <span style={{ fontWeight: "bold" }}>
                                        Synth:
                                    </span>{" "}
                                    A synthesizer is a sound generator. A sine
                                    wave is a smooth sounds, while a sawtooth is
                                    a rougher sound.
                                    <br />
                                    <br />
                                    <span style={{ fontWeight: "bold" }}>
                                    ...
                                    A sampler is a sound clip. You can choose
                                    from a variety of sound clips including
                                    piano, bell, epiano, harp, vox, 808, and
                                    909.
                                </span>
                            </div>
                        </h6>
